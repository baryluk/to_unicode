-module('to_unicode_table-8859-9').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-9.TXT
% at czw, 30 wrz 2010, 06:41:53 CEST using file version  with checksum
% md5sum dc12e2b5e874edc397380ffd8ae55ed2  ./unicode.org/Public/MAPPINGS/ISO8859/8859-9.TXT
...
m(16#A1) -> 16#00A1; % 16#A1 16#00A1 # INVERTED EXCLAMATION MARK
...
m(16#AA) -> 16#00AA; % 16#AA 16#00AA # FEMININE ORDINAL INDICATOR
...
m(16#BA) -> 16#00BA; % 16#BA 16#00BA # MASCULINE ORDINAL INDICATOR
...
m(16#BF) -> 16#00BF; % 16#BF 16#00BF # INVERTED QUESTION MARK
...
m(16#D0) -> 16#011E; % 16#D0 16#011E # LATIN CAPITAL LETTER G WITH BREVE
...
m(16#DD) -> 16#0130; % 16#DD 16#0130 # LATIN CAPITAL LETTER I WITH DOT ABOVE
m(16#DE) -> 16#015E; % 16#DE 16#015E # LATIN CAPITAL LETTER S WITH CEDILLA
...
m(16#F0) -> 16#011F; % 16#F0 16#011F # LATIN SMALL LETTER G WITH BREVE
...
m(16#FD) -> 16#0131; % 16#FD 16#0131 # LATIN SMALL LETTER DOTLESS I
m(16#FE) -> 16#015F; % 16#FE 16#015F # LATIN SMALL LETTER S WITH CEDILLA
