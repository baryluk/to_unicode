-module('to_unicode_table-8859-4').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-4.TXT
% at czw, 30 wrz 2010, 06:41:50 CEST using file version  with checksum
% md5sum de68d2887e903b683ac7de31fcf86e04  ./unicode.org/Public/MAPPINGS/ISO8859/8859-4.TXT
...
m(16#A2) -> 16#0138; % 16#A2 16#0138 # LATIN SMALL LETTER KRA
m(16#A3) -> 16#0156; % 16#A3 16#0156 # LATIN CAPITAL LETTER R WITH CEDILLA
m(16#A4) -> 16#00A4; % 16#A4 16#00A4 # CURRENCY SIGN
m(16#A5) -> 16#0128; % 16#A5 16#0128 # LATIN CAPITAL LETTER I WITH TILDE
m(16#A6) -> 16#013B; % 16#A6 16#013B # LATIN CAPITAL LETTER L WITH CEDILLA
...
m(16#AA) -> 16#0112; % 16#AA 16#0112 # LATIN CAPITAL LETTER E WITH MACRON
m(16#AB) -> 16#0122; % 16#AB 16#0122 # LATIN CAPITAL LETTER G WITH CEDILLA
m(16#AC) -> 16#0166; % 16#AC 16#0166 # LATIN CAPITAL LETTER T WITH STROKE
m(16#AD) -> 16#00AD; % 16#AD 16#00AD # SOFT HYPHEN
m(16#AE) -> 16#017D; % 16#AE 16#017D # LATIN CAPITAL LETTER Z WITH CARON
m(16#AF) -> 16#00AF; % 16#AF 16#00AF # MACRON
...
m(16#B3) -> 16#0157; % 16#B3 16#0157 # LATIN SMALL LETTER R WITH CEDILLA
m(16#B4) -> 16#00B4; % 16#B4 16#00B4 # ACUTE ACCENT
m(16#B5) -> 16#0129; % 16#B5 16#0129 # LATIN SMALL LETTER I WITH TILDE
m(16#B6) -> 16#013C; % 16#B6 16#013C # LATIN SMALL LETTER L WITH CEDILLA
...
m(16#BA) -> 16#0113; % 16#BA 16#0113 # LATIN SMALL LETTER E WITH MACRON
m(16#BB) -> 16#0123; % 16#BB 16#0123 # LATIN SMALL LETTER G WITH CEDILLA
m(16#BC) -> 16#0167; % 16#BC 16#0167 # LATIN SMALL LETTER T WITH STROKE
m(16#BD) -> 16#014A; % 16#BD 16#014A # LATIN CAPITAL LETTER ENG
m(16#BE) -> 16#017E; % 16#BE 16#017E # LATIN SMALL LETTER Z WITH CARON
m(16#BF) -> 16#014B; % 16#BF 16#014B # LATIN SMALL LETTER ENG
m(16#C0) -> 16#0100; % 16#C0 16#0100 # LATIN CAPITAL LETTER A WITH MACRON
...
m(16#C7) -> 16#012E; % 16#C7 16#012E # LATIN CAPITAL LETTER I WITH OGONEK
...
m(16#CC) -> 16#0116; % 16#CC 16#0116 # LATIN CAPITAL LETTER E WITH DOT ABOVE
...
m(16#CF) -> 16#012A; % 16#CF 16#012A # LATIN CAPITAL LETTER I WITH MACRON
m(16#D0) -> 16#0110; % 16#D0 16#0110 # LATIN CAPITAL LETTER D WITH STROKE
m(16#D1) -> 16#0145; % 16#D1 16#0145 # LATIN CAPITAL LETTER N WITH CEDILLA
m(16#D2) -> 16#014C; % 16#D2 16#014C # LATIN CAPITAL LETTER O WITH MACRON
m(16#D3) -> 16#0136; % 16#D3 16#0136 # LATIN CAPITAL LETTER K WITH CEDILLA
...
m(16#D9) -> 16#0172; % 16#D9 16#0172 # LATIN CAPITAL LETTER U WITH OGONEK
...
m(16#DD) -> 16#0168; % 16#DD 16#0168 # LATIN CAPITAL LETTER U WITH TILDE
m(16#DE) -> 16#016A; % 16#DE 16#016A # LATIN CAPITAL LETTER U WITH MACRON
m(16#DF) -> 16#00DF; % 16#DF 16#00DF # LATIN SMALL LETTER SHARP S
m(16#E0) -> 16#0101; % 16#E0 16#0101 # LATIN SMALL LETTER A WITH MACRON
...
m(16#E7) -> 16#012F; % 16#E7 16#012F # LATIN SMALL LETTER I WITH OGONEK
...
m(16#EC) -> 16#0117; % 16#EC 16#0117 # LATIN SMALL LETTER E WITH DOT ABOVE
...
m(16#EF) -> 16#012B; % 16#EF 16#012B # LATIN SMALL LETTER I WITH MACRON
m(16#F0) -> 16#0111; % 16#F0 16#0111 # LATIN SMALL LETTER D WITH STROKE
m(16#F1) -> 16#0146; % 16#F1 16#0146 # LATIN SMALL LETTER N WITH CEDILLA
m(16#F2) -> 16#014D; % 16#F2 16#014D # LATIN SMALL LETTER O WITH MACRON
m(16#F3) -> 16#0137; % 16#F3 16#0137 # LATIN SMALL LETTER K WITH CEDILLA
...
m(16#F9) -> 16#0173; % 16#F9 16#0173 # LATIN SMALL LETTER U WITH OGONEK
...
m(16#FD) -> 16#0169; % 16#FD 16#0169 # LATIN SMALL LETTER U WITH TILDE
m(16#FE) -> 16#016B; % 16#FE 16#016B # LATIN SMALL LETTER U WITH MACRON
