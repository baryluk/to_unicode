-module('to_unicode_table-8859-3').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-3.TXT
% at czw, 30 wrz 2010, 06:41:50 CEST using file version  with checksum
% md5sum 508e6e6c9944169639d3110e0b973ce0  ./unicode.org/Public/MAPPINGS/ISO8859/8859-3.TXT
...
m(16#A1) -> 16#0126; % 16#A1 16#0126 # LATIN CAPITAL LETTER H WITH STROKE
m(16#A2) -> 16#02D8; % 16#A2 16#02D8 # BREVE
m(16#A3) -> 16#00A3; % 16#A3 16#00A3 # POUND SIGN
m(16#A4) -> 16#00A4; % 16#A4 16#00A4 # CURRENCY SIGN
m(16#A6) -> 16#0124; % 16#A6 16#0124 # LATIN CAPITAL LETTER H WITH CIRCUMFLEX
m(16#A7) -> 16#00A7; % 16#A7 16#00A7 # SECTION SIGN
m(16#A8) -> 16#00A8; % 16#A8 16#00A8 # DIAERESIS
m(16#A9) -> 16#0130; % 16#A9 16#0130 # LATIN CAPITAL LETTER I WITH DOT ABOVE
m(16#AA) -> 16#015E; % 16#AA 16#015E # LATIN CAPITAL LETTER S WITH CEDILLA
m(16#AB) -> 16#011E; % 16#AB 16#011E # LATIN CAPITAL LETTER G WITH BREVE
m(16#AC) -> 16#0134; % 16#AC 16#0134 # LATIN CAPITAL LETTER J WITH CIRCUMFLEX
...
m(16#B1) -> 16#0127; % 16#B1 16#0127 # LATIN SMALL LETTER H WITH STROKE
...
m(16#B6) -> 16#0125; % 16#B6 16#0125 # LATIN SMALL LETTER H WITH CIRCUMFLEX
m(16#B7) -> 16#00B7; % 16#B7 16#00B7 # MIDDLE DOT
m(16#B8) -> 16#00B8; % 16#B8 16#00B8 # CEDILLA
m(16#B9) -> 16#0131; % 16#B9 16#0131 # LATIN SMALL LETTER DOTLESS I
m(16#BA) -> 16#015F; % 16#BA 16#015F # LATIN SMALL LETTER S WITH CEDILLA
m(16#BB) -> 16#011F; % 16#BB 16#011F # LATIN SMALL LETTER G WITH BREVE
m(16#BC) -> 16#0135; % 16#BC 16#0135 # LATIN SMALL LETTER J WITH CIRCUMFLEX
...
m(16#C5) -> 16#010A; % 16#C5 16#010A # LATIN CAPITAL LETTER C WITH DOT ABOVE
m(16#C6) -> 16#0108; % 16#C6 16#0108 # LATIN CAPITAL LETTER C WITH CIRCUMFLEX
...
m(16#D5) -> 16#0120; % 16#D5 16#0120 # LATIN CAPITAL LETTER G WITH DOT ABOVE
m(16#D6) -> 16#00D6; % 16#D6 16#00D6 # LATIN CAPITAL LETTER O WITH DIAERESIS
m(16#D7) -> 16#00D7; % 16#D7 16#00D7 # MULTIPLICATION SIGN
m(16#D8) -> 16#011C; % 16#D8 16#011C # LATIN CAPITAL LETTER G WITH CIRCUMFLEX
...
m(16#DD) -> 16#016C; % 16#DD 16#016C # LATIN CAPITAL LETTER U WITH BREVE
m(16#DE) -> 16#015C; % 16#DE 16#015C # LATIN CAPITAL LETTER S WITH CIRCUMFLEX
...
m(16#E5) -> 16#010B; % 16#E5 16#010B # LATIN SMALL LETTER C WITH DOT ABOVE
m(16#E6) -> 16#0109; % 16#E6 16#0109 # LATIN SMALL LETTER C WITH CIRCUMFLEX
...
m(16#F5) -> 16#0121; % 16#F5 16#0121 # LATIN SMALL LETTER G WITH DOT ABOVE
m(16#F6) -> 16#00F6; % 16#F6 16#00F6 # LATIN SMALL LETTER O WITH DIAERESIS
m(16#F7) -> 16#00F7; % 16#F7 16#00F7 # DIVISION SIGN
m(16#F8) -> 16#011D; % 16#F8 16#011D # LATIN SMALL LETTER G WITH CIRCUMFLEX
...
m(16#FD) -> 16#016D; % 16#FD 16#016D # LATIN SMALL LETTER U WITH BREVE
m(16#FE) -> 16#015D; % 16#FE 16#015D # LATIN SMALL LETTER S WITH CIRCUMFLEX
