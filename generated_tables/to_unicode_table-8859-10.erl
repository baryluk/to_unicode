-module('to_unicode_table-8859-10').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-10.TXT
% at czw, 30 wrz 2010, 06:41:46 CEST using file version  with checksum
% md5sum 1756fe8a4076a0acbaa84f31f73a5e18  ./unicode.org/Public/MAPPINGS/ISO8859/8859-10.TXT
...
m(16#A2) -> 16#0112; % 16#A2 16#0112 # LATIN CAPITAL LETTER E WITH MACRON
m(16#A3) -> 16#0122; % 16#A3 16#0122 # LATIN CAPITAL LETTER G WITH CEDILLA
m(16#A4) -> 16#012A; % 16#A4 16#012A # LATIN CAPITAL LETTER I WITH MACRON
m(16#A5) -> 16#0128; % 16#A5 16#0128 # LATIN CAPITAL LETTER I WITH TILDE
m(16#A6) -> 16#0136; % 16#A6 16#0136 # LATIN CAPITAL LETTER K WITH CEDILLA
m(16#A7) -> 16#00A7; % 16#A7 16#00A7 # SECTION SIGN
m(16#A8) -> 16#013B; % 16#A8 16#013B # LATIN CAPITAL LETTER L WITH CEDILLA
m(16#A9) -> 16#0110; % 16#A9 16#0110 # LATIN CAPITAL LETTER D WITH STROKE
m(16#AA) -> 16#0160; % 16#AA 16#0160 # LATIN CAPITAL LETTER S WITH CARON
m(16#AB) -> 16#0166; % 16#AB 16#0166 # LATIN CAPITAL LETTER T WITH STROKE
m(16#AC) -> 16#017D; % 16#AC 16#017D # LATIN CAPITAL LETTER Z WITH CARON
m(16#AD) -> 16#00AD; % 16#AD 16#00AD # SOFT HYPHEN
m(16#AE) -> 16#016A; % 16#AE 16#016A # LATIN CAPITAL LETTER U WITH MACRON
m(16#AF) -> 16#014A; % 16#AF 16#014A # LATIN CAPITAL LETTER ENG
m(16#B0) -> 16#00B0; % 16#B0 16#00B0 # DEGREE SIGN
m(16#B1) -> 16#0105; % 16#B1 16#0105 # LATIN SMALL LETTER A WITH OGONEK
m(16#B2) -> 16#0113; % 16#B2 16#0113 # LATIN SMALL LETTER E WITH MACRON
m(16#B3) -> 16#0123; % 16#B3 16#0123 # LATIN SMALL LETTER G WITH CEDILLA
m(16#B4) -> 16#012B; % 16#B4 16#012B # LATIN SMALL LETTER I WITH MACRON
m(16#B5) -> 16#0129; % 16#B5 16#0129 # LATIN SMALL LETTER I WITH TILDE
m(16#B6) -> 16#0137; % 16#B6 16#0137 # LATIN SMALL LETTER K WITH CEDILLA
m(16#B7) -> 16#00B7; % 16#B7 16#00B7 # MIDDLE DOT
m(16#B8) -> 16#013C; % 16#B8 16#013C # LATIN SMALL LETTER L WITH CEDILLA
m(16#B9) -> 16#0111; % 16#B9 16#0111 # LATIN SMALL LETTER D WITH STROKE
m(16#BA) -> 16#0161; % 16#BA 16#0161 # LATIN SMALL LETTER S WITH CARON
m(16#BB) -> 16#0167; % 16#BB 16#0167 # LATIN SMALL LETTER T WITH STROKE
m(16#BC) -> 16#017E; % 16#BC 16#017E # LATIN SMALL LETTER Z WITH CARON
m(16#BD) -> 16#2015; % 16#BD 16#2015 # HORIZONTAL BAR
m(16#BE) -> 16#016B; % 16#BE 16#016B # LATIN SMALL LETTER U WITH MACRON
...
m(16#D0) -> 16#00D0; % 16#D0 16#00D0 # LATIN CAPITAL LETTER ETH (Icelandic)
...
m(16#D7) -> 16#0168; % 16#D7 16#0168 # LATIN CAPITAL LETTER U WITH TILDE
...
m(16#DE) -> 16#00DE; % 16#DE 16#00DE # LATIN CAPITAL LETTER THORN (Icelandic)
...
m(16#F0) -> 16#00F0; % 16#F0 16#00F0 # LATIN SMALL LETTER ETH (Icelandic)
...
m(16#F7) -> 16#0169; % 16#F7 16#0169 # LATIN SMALL LETTER U WITH TILDE
...
m(16#FE) -> 16#00FE; % 16#FE 16#00FE # LATIN SMALL LETTER THORN (Icelandic)
m(16#FF) -> 16#0138; % 16#FF 16#0138 # LATIN SMALL LETTER KRA
m(_) -> throw(badarg).
