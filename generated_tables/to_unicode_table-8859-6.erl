-module('to_unicode_table-8859-6').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-6.TXT
% at czw, 30 wrz 2010, 06:41:51 CEST using file version  with checksum
% md5sum 0b6fca3cf6ced7832ec98bd83e9d8573  ./unicode.org/Public/MAPPINGS/ISO8859/8859-6.TXT
...
m(16#AC) -> 16#060C; % 16#AC 16#060C # ARABIC COMMA
m(16#AD) -> 16#00AD; % 16#AD 16#00AD # SOFT HYPHEN
m(16#BB) -> 16#061B; % 16#BB 16#061B # ARABIC SEMICOLON
m(16#BF) -> 16#061F; % 16#BF 16#061F # ARABIC QUESTION MARK
m(16#C1) -> 16#0621; % 16#C1 16#0621 # ARABIC LETTER HAMZA
m(16#C2) -> 16#0622; % 16#C2 16#0622 # ARABIC LETTER ALEF WITH MADDA ABOVE
m(16#C3) -> 16#0623; % 16#C3 16#0623 # ARABIC LETTER ALEF WITH HAMZA ABOVE
m(16#C4) -> 16#0624; % 16#C4 16#0624 # ARABIC LETTER WAW WITH HAMZA ABOVE
m(16#C5) -> 16#0625; % 16#C5 16#0625 # ARABIC LETTER ALEF WITH HAMZA BELOW
m(16#C6) -> 16#0626; % 16#C6 16#0626 # ARABIC LETTER YEH WITH HAMZA ABOVE
m(16#C7) -> 16#0627; % 16#C7 16#0627 # ARABIC LETTER ALEF
m(16#C8) -> 16#0628; % 16#C8 16#0628 # ARABIC LETTER BEH
m(16#C9) -> 16#0629; % 16#C9 16#0629 # ARABIC LETTER TEH MARBUTA
m(16#CA) -> 16#062A; % 16#CA 16#062A # ARABIC LETTER TEH
m(16#CB) -> 16#062B; % 16#CB 16#062B # ARABIC LETTER THEH
m(16#CC) -> 16#062C; % 16#CC 16#062C # ARABIC LETTER JEEM
m(16#CD) -> 16#062D; % 16#CD 16#062D # ARABIC LETTER HAH
m(16#CE) -> 16#062E; % 16#CE 16#062E # ARABIC LETTER KHAH
m(16#CF) -> 16#062F; % 16#CF 16#062F # ARABIC LETTER DAL
m(16#D0) -> 16#0630; % 16#D0 16#0630 # ARABIC LETTER THAL
m(16#D1) -> 16#0631; % 16#D1 16#0631 # ARABIC LETTER REH
m(16#D2) -> 16#0632; % 16#D2 16#0632 # ARABIC LETTER ZAIN
m(16#D3) -> 16#0633; % 16#D3 16#0633 # ARABIC LETTER SEEN
m(16#D4) -> 16#0634; % 16#D4 16#0634 # ARABIC LETTER SHEEN
m(16#D5) -> 16#0635; % 16#D5 16#0635 # ARABIC LETTER SAD
m(16#D6) -> 16#0636; % 16#D6 16#0636 # ARABIC LETTER DAD
m(16#D7) -> 16#0637; % 16#D7 16#0637 # ARABIC LETTER TAH
m(16#D8) -> 16#0638; % 16#D8 16#0638 # ARABIC LETTER ZAH
m(16#D9) -> 16#0639; % 16#D9 16#0639 # ARABIC LETTER AIN
m(16#DA) -> 16#063A; % 16#DA 16#063A # ARABIC LETTER GHAIN
m(16#E0) -> 16#0640; % 16#E0 16#0640 # ARABIC TATWEEL
m(16#E1) -> 16#0641; % 16#E1 16#0641 # ARABIC LETTER FEH
m(16#E2) -> 16#0642; % 16#E2 16#0642 # ARABIC LETTER QAF
m(16#E3) -> 16#0643; % 16#E3 16#0643 # ARABIC LETTER KAF
m(16#E4) -> 16#0644; % 16#E4 16#0644 # ARABIC LETTER LAM
m(16#E5) -> 16#0645; % 16#E5 16#0645 # ARABIC LETTER MEEM
m(16#E6) -> 16#0646; % 16#E6 16#0646 # ARABIC LETTER NOON
m(16#E7) -> 16#0647; % 16#E7 16#0647 # ARABIC LETTER HEH
m(16#E8) -> 16#0648; % 16#E8 16#0648 # ARABIC LETTER WAW
m(16#E9) -> 16#0649; % 16#E9 16#0649 # ARABIC LETTER ALEF MAKSURA
m(16#EA) -> 16#064A; % 16#EA 16#064A # ARABIC LETTER YEH
m(16#EB) -> 16#064B; % 16#EB 16#064B # ARABIC FATHATAN
m(16#EC) -> 16#064C; % 16#EC 16#064C # ARABIC DAMMATAN
m(16#ED) -> 16#064D; % 16#ED 16#064D # ARABIC KASRATAN
m(16#EE) -> 16#064E; % 16#EE 16#064E # ARABIC FATHA
m(16#EF) -> 16#064F; % 16#EF 16#064F # ARABIC DAMMA
m(16#F0) -> 16#0650; % 16#F0 16#0650 # ARABIC KASRA
m(16#F1) -> 16#0651; % 16#F1 16#0651 # ARABIC SHADDA
m(16#F2) -> 16#0652; % 16#F2 16#0652 # ARABIC SUKUN
m(_) -> throw(badarg).
