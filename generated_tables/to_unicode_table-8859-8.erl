-module('to_unicode_table-8859-8').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-8.TXT
% at czw, 30 wrz 2010, 06:41:52 CEST using file version  with checksum
% md5sum c77336d026dc44cb4bfa23dd89fa9dde  ./unicode.org/Public/MAPPINGS/ISO8859/8859-8.TXT
...
m(16#A5) -> 16#00A5; % 16#A5 16#00A5 # YEN SIGN
...
m(16#AA) -> 16#00D7; % 16#AA 16#00D7 # MULTIPLICATION SIGN
...
m(16#BA) -> 16#00F7; % 16#BA 16#00F7 # DIVISION SIGN
...
m(16#DF) -> 16#2017; % 16#DF 16#2017 # DOUBLE LOW LINE
m(16#E0) -> 16#05D0; % 16#E0 16#05D0 # HEBREW LETTER ALEF
m(16#E1) -> 16#05D1; % 16#E1 16#05D1 # HEBREW LETTER BET
m(16#E2) -> 16#05D2; % 16#E2 16#05D2 # HEBREW LETTER GIMEL
m(16#E3) -> 16#05D3; % 16#E3 16#05D3 # HEBREW LETTER DALET
m(16#E4) -> 16#05D4; % 16#E4 16#05D4 # HEBREW LETTER HE
m(16#E5) -> 16#05D5; % 16#E5 16#05D5 # HEBREW LETTER VAV
m(16#E6) -> 16#05D6; % 16#E6 16#05D6 # HEBREW LETTER ZAYIN
m(16#E7) -> 16#05D7; % 16#E7 16#05D7 # HEBREW LETTER HET
m(16#E8) -> 16#05D8; % 16#E8 16#05D8 # HEBREW LETTER TET
m(16#E9) -> 16#05D9; % 16#E9 16#05D9 # HEBREW LETTER YOD
m(16#EA) -> 16#05DA; % 16#EA 16#05DA # HEBREW LETTER FINAL KAF
m(16#EB) -> 16#05DB; % 16#EB 16#05DB # HEBREW LETTER KAF
m(16#EC) -> 16#05DC; % 16#EC 16#05DC # HEBREW LETTER LAMED
m(16#ED) -> 16#05DD; % 16#ED 16#05DD # HEBREW LETTER FINAL MEM
m(16#EE) -> 16#05DE; % 16#EE 16#05DE # HEBREW LETTER MEM
m(16#EF) -> 16#05DF; % 16#EF 16#05DF # HEBREW LETTER FINAL NUN
m(16#F0) -> 16#05E0; % 16#F0 16#05E0 # HEBREW LETTER NUN
m(16#F1) -> 16#05E1; % 16#F1 16#05E1 # HEBREW LETTER SAMEKH
m(16#F2) -> 16#05E2; % 16#F2 16#05E2 # HEBREW LETTER AYIN
m(16#F3) -> 16#05E3; % 16#F3 16#05E3 # HEBREW LETTER FINAL PE
m(16#F4) -> 16#05E4; % 16#F4 16#05E4 # HEBREW LETTER PE
m(16#F5) -> 16#05E5; % 16#F5 16#05E5 # HEBREW LETTER FINAL TSADI
m(16#F6) -> 16#05E6; % 16#F6 16#05E6 # HEBREW LETTER TSADI
m(16#F7) -> 16#05E7; % 16#F7 16#05E7 # HEBREW LETTER QOF
m(16#F8) -> 16#05E8; % 16#F8 16#05E8 # HEBREW LETTER RESH
m(16#F9) -> 16#05E9; % 16#F9 16#05E9 # HEBREW LETTER SHIN
m(16#FA) -> 16#05EA; % 16#FA 16#05EA # HEBREW LETTER TAV
m(16#FD) -> 16#200E; % 16#FD 16#200E # LEFT-TO-RIGHT MARK
m(16#FE) -> 16#200F; % 16#FE 16#200F # RIGHT-TO-LEFT MARK
m(_) -> throw(badarg).
