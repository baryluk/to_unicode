-module('to_unicode_table-8859-16').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-16.TXT
% at czw, 30 wrz 2010, 06:41:48 CEST using file version  with checksum
% md5sum f905f3043c0b8265c64fb80ec9e747c3  ./unicode.org/Public/MAPPINGS/ISO8859/8859-16.TXT
...
m(16#A2) -> 16#0105; % 16#A2 16#0105 # LATIN SMALL LETTER A WITH OGONEK
...
m(16#A6) -> 16#0160; % 16#A6 16#0160 # LATIN CAPITAL LETTER S WITH CARON
m(16#A7) -> 16#00A7; % 16#A7 16#00A7 # SECTION SIGN
m(16#A8) -> 16#0161; % 16#A8 16#0161 # LATIN SMALL LETTER S WITH CARON
m(16#A9) -> 16#00A9; % 16#A9 16#00A9 # COPYRIGHT SIGN
m(16#AA) -> 16#0218; % 16#AA 16#0218 # LATIN CAPITAL LETTER S WITH COMMA BELOW
...
m(16#AE) -> 16#017A; % 16#AE 16#017A # LATIN SMALL LETTER Z WITH ACUTE
...
m(16#B2) -> 16#010C; % 16#B2 16#010C # LATIN CAPITAL LETTER C WITH CARON
m(16#B3) -> 16#0142; % 16#B3 16#0142 # LATIN SMALL LETTER L WITH STROKE
m(16#B4) -> 16#017D; % 16#B4 16#017D # LATIN CAPITAL LETTER Z WITH CARON
m(16#B5) -> 16#201D; % 16#B5 16#201D # RIGHT DOUBLE QUOTATION MARK
m(16#B6) -> 16#00B6; % 16#B6 16#00B6 # PILCROW SIGN
m(16#B7) -> 16#00B7; % 16#B7 16#00B7 # MIDDLE DOT
m(16#B8) -> 16#017E; % 16#B8 16#017E # LATIN SMALL LETTER Z WITH CARON
m(16#B9) -> 16#010D; % 16#B9 16#010D # LATIN SMALL LETTER C WITH CARON
m(16#BA) -> 16#0219; % 16#BA 16#0219 # LATIN SMALL LETTER S WITH COMMA BELOW
m(16#BB) -> 16#00BB; % 16#BB 16#00BB # RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
m(16#BC) -> 16#0152; % 16#BC 16#0152 # LATIN CAPITAL LIGATURE OE
m(16#BD) -> 16#0153; % 16#BD 16#0153 # LATIN SMALL LIGATURE OE
m(16#BE) -> 16#0178; % 16#BE 16#0178 # LATIN CAPITAL LETTER Y WITH DIAERESIS
...
m(16#C5) -> 16#0106; % 16#C5 16#0106 # LATIN CAPITAL LETTER C WITH ACUTE
...
m(16#D7) -> 16#015A; % 16#D7 16#015A # LATIN CAPITAL LETTER S WITH ACUTE
m(16#D8) -> 16#0170; % 16#D8 16#0170 # LATIN CAPITAL LETTER U WITH DOUBLE ACUTE
...
m(16#DD) -> 16#0118; % 16#DD 16#0118 # LATIN CAPITAL LETTER E WITH OGONEK
m(16#DE) -> 16#021A; % 16#DE 16#021A # LATIN CAPITAL LETTER T WITH COMMA BELOW
...
m(16#E5) -> 16#0107; % 16#E5 16#0107 # LATIN SMALL LETTER C WITH ACUTE
...
m(16#F7) -> 16#015B; % 16#F7 16#015B # LATIN SMALL LETTER S WITH ACUTE
m(16#F8) -> 16#0171; % 16#F8 16#0171 # LATIN SMALL LETTER U WITH DOUBLE ACUTE
...
m(16#FD) -> 16#0119; % 16#FD 16#0119 # LATIN SMALL LETTER E WITH OGONEK
m(16#FE) -> 16#021B; % 16#FE 16#021B # LATIN SMALL LETTER T WITH COMMA BELOW
