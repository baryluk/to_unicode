-module('to_unicode_table-8859-13').

% Automatically generated file by to_unicode/gen.sh from ./unicode.org/Public/MAPPINGS/ISO8859/8859-13.TXT
% at czw, 30 wrz 2010, 06:41:47 CEST using file version  with checksum
% md5sum f97c84a786088bd85262f57df05408fd  ./unicode.org/Public/MAPPINGS/ISO8859/8859-13.TXT
...
m(16#A1) -> 16#201D; % 16#A1 16#201D # RIGHT DOUBLE QUOTATION MARK
m(16#A2) -> 16#00A2; % 16#A2 16#00A2 # CENT SIGN
m(16#A3) -> 16#00A3; % 16#A3 16#00A3 # POUND SIGN
m(16#A4) -> 16#00A4; % 16#A4 16#00A4 # CURRENCY SIGN
m(16#A5) -> 16#201E; % 16#A5 16#201E # DOUBLE LOW-9 QUOTATION MARK
m(16#A6) -> 16#00A6; % 16#A6 16#00A6 # BROKEN BAR
m(16#A7) -> 16#00A7; % 16#A7 16#00A7 # SECTION SIGN
m(16#A8) -> 16#00D8; % 16#A8 16#00D8 # LATIN CAPITAL LETTER O WITH STROKE
m(16#A9) -> 16#00A9; % 16#A9 16#00A9 # COPYRIGHT SIGN
m(16#AA) -> 16#0156; % 16#AA 16#0156 # LATIN CAPITAL LETTER R WITH CEDILLA
...
m(16#AF) -> 16#00C6; % 16#AF 16#00C6 # LATIN CAPITAL LETTER AE
...
m(16#B4) -> 16#201C; % 16#B4 16#201C # LEFT DOUBLE QUOTATION MARK
m(16#B5) -> 16#00B5; % 16#B5 16#00B5 # MICRO SIGN
m(16#B6) -> 16#00B6; % 16#B6 16#00B6 # PILCROW SIGN
m(16#B7) -> 16#00B7; % 16#B7 16#00B7 # MIDDLE DOT
m(16#B8) -> 16#00F8; % 16#B8 16#00F8 # LATIN SMALL LETTER O WITH STROKE
m(16#B9) -> 16#00B9; % 16#B9 16#00B9 # SUPERSCRIPT ONE
m(16#BA) -> 16#0157; % 16#BA 16#0157 # LATIN SMALL LETTER R WITH CEDILLA
m(16#BB) -> 16#00BB; % 16#BB 16#00BB # RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
m(16#BC) -> 16#00BC; % 16#BC 16#00BC # VULGAR FRACTION ONE QUARTER
m(16#BD) -> 16#00BD; % 16#BD 16#00BD # VULGAR FRACTION ONE HALF
m(16#BE) -> 16#00BE; % 16#BE 16#00BE # VULGAR FRACTION THREE QUARTERS
m(16#BF) -> 16#00E6; % 16#BF 16#00E6 # LATIN SMALL LETTER AE
m(16#C0) -> 16#0104; % 16#C0 16#0104 # LATIN CAPITAL LETTER A WITH OGONEK
m(16#C1) -> 16#012E; % 16#C1 16#012E # LATIN CAPITAL LETTER I WITH OGONEK
m(16#C2) -> 16#0100; % 16#C2 16#0100 # LATIN CAPITAL LETTER A WITH MACRON
m(16#C3) -> 16#0106; % 16#C3 16#0106 # LATIN CAPITAL LETTER C WITH ACUTE
...
m(16#C6) -> 16#0118; % 16#C6 16#0118 # LATIN CAPITAL LETTER E WITH OGONEK
m(16#C7) -> 16#0112; % 16#C7 16#0112 # LATIN CAPITAL LETTER E WITH MACRON
...
m(16#CA) -> 16#0179; % 16#CA 16#0179 # LATIN CAPITAL LETTER Z WITH ACUTE
m(16#CB) -> 16#0116; % 16#CB 16#0116 # LATIN CAPITAL LETTER E WITH DOT ABOVE
m(16#CC) -> 16#0122; % 16#CC 16#0122 # LATIN CAPITAL LETTER G WITH CEDILLA
m(16#CD) -> 16#0136; % 16#CD 16#0136 # LATIN CAPITAL LETTER K WITH CEDILLA
m(16#CE) -> 16#012A; % 16#CE 16#012A # LATIN CAPITAL LETTER I WITH MACRON
m(16#CF) -> 16#013B; % 16#CF 16#013B # LATIN CAPITAL LETTER L WITH CEDILLA
m(16#D0) -> 16#0160; % 16#D0 16#0160 # LATIN CAPITAL LETTER S WITH CARON
m(16#D1) -> 16#0143; % 16#D1 16#0143 # LATIN CAPITAL LETTER N WITH ACUTE
m(16#D2) -> 16#0145; % 16#D2 16#0145 # LATIN CAPITAL LETTER N WITH CEDILLA
m(16#D3) -> 16#00D3; % 16#D3 16#00D3 # LATIN CAPITAL LETTER O WITH ACUTE
m(16#D4) -> 16#014C; % 16#D4 16#014C # LATIN CAPITAL LETTER O WITH MACRON
...
m(16#D8) -> 16#0172; % 16#D8 16#0172 # LATIN CAPITAL LETTER U WITH OGONEK
m(16#D9) -> 16#0141; % 16#D9 16#0141 # LATIN CAPITAL LETTER L WITH STROKE
m(16#DA) -> 16#015A; % 16#DA 16#015A # LATIN CAPITAL LETTER S WITH ACUTE
m(16#DB) -> 16#016A; % 16#DB 16#016A # LATIN CAPITAL LETTER U WITH MACRON
m(16#DC) -> 16#00DC; % 16#DC 16#00DC # LATIN CAPITAL LETTER U WITH DIAERESIS
m(16#DD) -> 16#017B; % 16#DD 16#017B # LATIN CAPITAL LETTER Z WITH DOT ABOVE
m(16#DE) -> 16#017D; % 16#DE 16#017D # LATIN CAPITAL LETTER Z WITH CARON
m(16#DF) -> 16#00DF; % 16#DF 16#00DF # LATIN SMALL LETTER SHARP S (German)
m(16#E0) -> 16#0105; % 16#E0 16#0105 # LATIN SMALL LETTER A WITH OGONEK
m(16#E1) -> 16#012F; % 16#E1 16#012F # LATIN SMALL LETTER I WITH OGONEK
m(16#E2) -> 16#0101; % 16#E2 16#0101 # LATIN SMALL LETTER A WITH MACRON
m(16#E3) -> 16#0107; % 16#E3 16#0107 # LATIN SMALL LETTER C WITH ACUTE
...
m(16#E6) -> 16#0119; % 16#E6 16#0119 # LATIN SMALL LETTER E WITH OGONEK
m(16#E7) -> 16#0113; % 16#E7 16#0113 # LATIN SMALL LETTER E WITH MACRON
...
m(16#EA) -> 16#017A; % 16#EA 16#017A # LATIN SMALL LETTER Z WITH ACUTE
m(16#EB) -> 16#0117; % 16#EB 16#0117 # LATIN SMALL LETTER E WITH DOT ABOVE
m(16#EC) -> 16#0123; % 16#EC 16#0123 # LATIN SMALL LETTER G WITH CEDILLA
m(16#ED) -> 16#0137; % 16#ED 16#0137 # LATIN SMALL LETTER K WITH CEDILLA
m(16#EE) -> 16#012B; % 16#EE 16#012B # LATIN SMALL LETTER I WITH MACRON
m(16#EF) -> 16#013C; % 16#EF 16#013C # LATIN SMALL LETTER L WITH CEDILLA
m(16#F0) -> 16#0161; % 16#F0 16#0161 # LATIN SMALL LETTER S WITH CARON
m(16#F1) -> 16#0144; % 16#F1 16#0144 # LATIN SMALL LETTER N WITH ACUTE
m(16#F2) -> 16#0146; % 16#F2 16#0146 # LATIN SMALL LETTER N WITH CEDILLA
m(16#F3) -> 16#00F3; % 16#F3 16#00F3 # LATIN SMALL LETTER O WITH ACUTE
m(16#F4) -> 16#014D; % 16#F4 16#014D # LATIN SMALL LETTER O WITH MACRON
...
m(16#F8) -> 16#0173; % 16#F8 16#0173 # LATIN SMALL LETTER U WITH OGONEK
m(16#F9) -> 16#0142; % 16#F9 16#0142 # LATIN SMALL LETTER L WITH STROKE
m(16#FA) -> 16#015B; % 16#FA 16#015B # LATIN SMALL LETTER S WITH ACUTE
m(16#FB) -> 16#016B; % 16#FB 16#016B # LATIN SMALL LETTER U WITH MACRON
m(16#FC) -> 16#00FC; % 16#FC 16#00FC # LATIN SMALL LETTER U WITH DIAERESIS
m(16#FD) -> 16#017C; % 16#FD 16#017C # LATIN SMALL LETTER Z WITH DOT ABOVE
m(16#FE) -> 16#017E; % 16#FE 16#017E # LATIN SMALL LETTER Z WITH CARON
m(16#FF) -> 16#2019; % 16#FF 16#2019 # RIGHT SINGLE QUOTATION MARK
m(_) -> throw(badarg).
